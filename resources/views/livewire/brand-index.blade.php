<div>
    ...
    <div class="mt-4">
        <input wire:model.live.debounce.300ms="search" type="text" placeholder="Cari merek..."
    ...
    <div class="mt-6 overflow-hidden shadow ring-1 ring-black/5 sm:rounded-lg">
        <table class="min-w-full divide-y divide-gray-300">
            ...
            <tbody class="divide-y divide-gray-200 bg-white">
                @forelse($brands as $brand)
                    <tr>
                        <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900">
                            {{ $brand->name }}</td>
                        <td class="px-3 py-4 text-sm text-gray-500">{{ Str::limit($brand->description, 50) ?? '-' }}
                        </td>
                ...
                @empty
                    <tr>
                        <td colspan="4" class="py-4 text-center text-sm text-gray-500">Belum ada data merek.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
