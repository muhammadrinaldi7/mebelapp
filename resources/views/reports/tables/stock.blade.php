<table class="min-w-full divide-y divide-gray-200">
    <thead class="bg-gray-50">
        <tr>
            ...
            <th class="px-3 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wide">Kategori & Merek
            </th>
            <th class="px-3 py-3 text-right text-xs font-semibold text-gray-600 uppercase tracking-wide">Fisik (Unit)
            </th>
    ...
    <tbody class="divide-y divide-gray-100 bg-white">
        @forelse($products as $product)
            <tr>
                ...
                <td
                    class="whitespace-nowrap px-3 py-3 text-sm text-right font-bold {{ $product->current_stock <= 5 ? 'text-red-600' : 'text-gray-900' }}">
