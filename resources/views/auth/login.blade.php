...
<body class="h-full antialiased" style="background: linear-gradient(135deg, #1e1b4b 0%, #312e81 50%, #4338ca 100%);">
    <div class="min-h-full flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div class="sm:mx-auto sm:w-full sm:max-w-sm text-center">
            <div
                class="mx-auto w-16 h-16 rounded-3xl bg-white backdrop-blur-sm flex items-center justify-center shadow-lg mb-6">
                <span class="text-3xl">
                    <img src="{{ asset('storage/img/mebellogo.png') }}" alt="Logo"
                        class="w-16 h-16 bg-white rounded-3xl">
                </span>
            </div>
        ...
        <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-sm">
            <div class="bg-white/95 backdrop-blur-xl rounded-2xl shadow-2xl p-7 ring-1 ring-white/20">
                <form class="space-y-5" action="{{ route('login') }}" method="POST">
                    ...
                    <div>
                        <label for="password"
                            class="block text-[13px] font-medium text-gray-700 mb-1.5">Password</label>
                    ...
                    <div class="flex items-center">
                        <input id="remember" name="remember" type="checkbox"
                            class="h-4 w-4 rounded-md border-gray-300 text-indigo-600 focus:ring-indigo-500/30">
